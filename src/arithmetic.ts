...
const isLittleEndian = (() => {
  ...
  return dataView.getUint8(0) === 0x34;
})();

const arithmetic = <T extends Types>(
  type: T, littleEndian: boolean = isLittleEndian,
